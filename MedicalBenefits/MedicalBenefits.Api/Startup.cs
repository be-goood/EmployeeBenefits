...
using MedicalBenefits.Sql.Queries;
...
namespace MedicalBenefits.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IQueryNoParam<CostRule>>(_ => new GetEmployeeCostRulesQuery(_apiSettings.ConnectionString));
